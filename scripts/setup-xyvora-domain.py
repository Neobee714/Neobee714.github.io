...
# xyvora.me (new domain)
server {
    listen 443 ssl;
    server_name xyvora.me www.xyvora.me;

    ssl_certificate /etc/letsencrypt/live/xyvora.me/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/xyvora.me/privkey.pem;
...
# neobee.top -> redirect to xyvora.me
server {
    listen 443 ssl;
